...
},{"./randomWord.vue":5,"vue":3}],5:[function(require,module,exports){
'use strict';
...
exports.default = {
	data: function data() {
		return {
			...
			words: ['lvpeng', 'xiaofan', 'lvbin', 'mother', 'father']
		};
	},
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-1b289d9e", module.exports)
  } else {
    hotAPI.update("_v-1b289d9e", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
